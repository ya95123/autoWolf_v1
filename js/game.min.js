...
if(modelPlaying.processNight[order]==="預"){textTop.classList.add("text-gold");textTop.innerText="預言家請睜眼";if(functionState.prophet.alive===false){gammingTips.innerText="請選擇你要查驗的對象\n預言家請閉眼😌\n(預言家已死👻)\n\n點擊畫面下一步";order++;return;}
...
if(modelPlaying.processNight[order]==="巫"){console.log("女巫技能狀態：",functionState.witch);if(functionState.witch.start)return;functionState.witch.start=true;gammingNumber.classList.add("none");textTop.innerText="女巫請睜眼";if(functionState.witch.alive===false){if(functionState.witch.antidote===false&&functionState.witch.poison===false){gammingTips.innerText="你已使用完兩瓶藥\n女巫請閉眼😌\n(女巫已死👻)\n\n點擊畫面下一步";}
if(functionState.witch.antidote===false&&functionState.witch.poison===true){gammingTips.innerText="你要使用毒藥嗎？\n女巫請閉眼😌\n(女巫已死👻)\n\n點擊畫面下一步";}
if(functionState.witch.antidote===true&&functionState.witch.poison===false){gammingTips.innerText="\u4F60\u8981\u4F7F\u7528\u89E3\u85E5\u6551\u4EBA\u55CE\uFF1F\n\u5973\u5DEB\u8ACB\u9589\u773C\uD83D\uDE0C\n(\u5973\u5DEB\u5DF2\u6B7B\uD83D\uDC7B)\n\n\u9EDE\u64CA\u756B\u9762\u4E0B\u4E00\u6B65";}
if(functionState.witch.antidote===true&&functionState.witch.poison===true){gammingTips.innerText="\u4F60\u8981\u4F7F\u7528\u89E3\u85E5\u6551\u4EBA\u55CE\uFF1F\n\u4F60\u8981\u4F7F\u7528\u6BD2\u85E5\u55CE\uFF1F\n\u5973\u5DEB\u8ACB\u9589\u773C\uD83D\uDE0C\n(\u5973\u5DEB\u5DF2\u6B7B\uD83D\uDC7B)\n\n\u9EDE\u64CA\u756B\u9762\u4E0B\u4E00\u6B65";}
order++;return;}
if(functionState.witch.antidote===false&&functionState.witch.poison===false){gammingTips.innerText="你已使用完兩瓶藥\n女巫請閉眼😌\n點擊畫面下一步";order++;return;}
gammingChoose.classList.remove("none");if(functionState.witch.antidote===true){characterList[killed[0]].character==="女巫"?gammingTips.innerText="\u4F60\u8981\u4F7F\u7528\u89E3\u85E5\u6551\u4EBA\u55CE\uFF1F\n("+characterList[killed[0]].id+" \u865F\u88AB\u6BBA\u4E86)\n(\u5973\u5DEB\u4E0D\u80FD\u81EA\u6551)":gammingTips.innerText="\u4F60\u8981\u4F7F\u7528\u89E3\u85E5\u6551\u4EBA\u55CE\uFF1F\n("+characterList[killed[0]].id+" \u865F\u88AB\u6BBA\u4E86)";chooses[0].innerText="救";chooses[1].innerText="不救";return;}
...
console.log("發言順序 idx",speakOrder);gammingNext.addEventListener("click",nextClick,false);gammingFunction.addEventListener("click",functionClick,false);};var nextClick=function nextClick(){if(isGameOver===true){console.log("再來一局");return;}
