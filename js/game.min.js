...
console.log("發言順序 idx",speakOrder);gammingNext.addEventListener("click",nextClick,false);gammingFunction.addEventListener("click",functionClick,false);};var nextClick=function nextClick(){if(gammingNext.innerText==="再來一局"){console.log("再來一局");location.href.includes("github")?location.href="https://ya95123.github.io/autoWolf_v1/":location.href="/public";return;}
