...
console.log("發言順序 idx",speakOrder);gammingNext.addEventListener("click",nextClick,false);gammingFunction.addEventListener("click",functionClick,false);};var nextClick=function nextClick(){speakOrder.splice(0,1);console.log("發言順序 idx",speakOrder);if(gammingNext.innerText==="再來一局"){console.log("再來一局");location.reload();return;}
if(speakOrder.length===0){console.log("投票");gammingNext.classList.add("none");gammingNumber.classList.remove("none");gammingFunction.setAttribute("class","voteToNight");textTop.innerText="進行投票";gammingTips.innerText="數到 3，請比出要投出去的對象\n若無人出局、連續兩次平票\n請點選「進天黑」";gammingFunction.innerText="進天黑";return;}
