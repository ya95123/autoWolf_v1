...
var giveCharacter = document.getElementById("giveCharacter");
var gamming = document.getElementById("gamming");
var giveRound = document.querySelector(".give-round");
var textTop = document.getElementById("text-top");
var gammingTips = document.getElementById("gamming-tips");
var gammingNumber = document.getElementById("gamming-number");
var gammingChoose = document.getElementById("gamming-choose");
var gammingFunction = document.getElementById("gamming-function");
var gammingNext = document.getElementById("gamming-next");
...
var cate = modelData.cate;
var modelPlaying = {}; // 所選模式
var characterList = []; // 給的 身分 & 順序
var giveCharacterOrder = 0; // 發身分順序紀錄
var giveTipsText = void 0; // 發身分提示變化換
var numbers = void 0; // 成員號碼 div
var order = 0; // 流程順序
var killed = []; // 夜晚被殺 [0]狼殺 [1]毒殺
var score = []; // 分數紀錄
var isGameOver = false; // 是否遊戲結束
var startNum = void 0; // 開始發言號碼
var speakOrder = []; // 白天發言循環 arr
var lastCharacterLisetLen = void 0; // 白天剩餘發言的長度
var nextFirst = void 0; // 白天下一位發言的 idx
// 夜晚、白天有功能角色的紀錄
var functionState = {
  "prophet": { "alive": true },
  "witch": {
  ...
  var randArr = (window.crypto || window.msCrypto).getRandomValues(new Uint32Array(1));
  var randNum = randArr[0] / (0xffffffff + 1);
  return Math.floor(randNum * (max - min + 1) + min);
};

// *選擇模式
var selectModel = function selectModel(idx) {
...
var give = function give() {
  var id = void 0,
      ...
      randNum = void 0,
      team = void 0;
  var allNum = modelPlaying.peopleNum - 1;

  // 設定初始直
  for (var i = 0; i < modelPlaying.peopleNum; i++) {
    id = i + 1;
...
// *發身分 畫面
var giveHtml = function giveHtml() {
  var giveNum = document.querySelector(".give-num");
  var giveTips = document.querySelector(".give-tips");
  var give_character = document.querySelector(".give-character");
  var lastOrder = characterList.length - 1;
  ...
  // click giveRound
  giveRound.addEventListener("click", function () {
    // *順序 - click 要給身分
...
// *夜晚流程
var nightFlow = function nightFlow(e) {
  e.preventDefault();
  ...
  if (modelPlaying.processNight[order] === "天亮") {
    ...
    // 刪除為 -1 的
    killed = killed.filter(function (num) {
      return num >= 0;
    });
...
var numbersChoosesClick = function numbersChoosesClick() {
  // *click number
  numbers.forEach(function (item, idx) {
    item.addEventListener("click", function (e) {
      ...
      if (characterList[speakOrder[0]].character === "騎士") {
        ...
        // *狼死
        var knightKill = void 0; // 騎士即將撞死的對象
...
// *白天 - 判斷是神或狼，要顯示功能
var morningFunction = function morningFunction(idx) {
  if (characterList[idx].team === "wolfs") {
...
var handleSpeakOrder = function handleSpeakOrder() {
  // 發言循環
  speakOrder = [];
  ...
  // *處理 speakOrder Arr
  for (var i = 0; i < lastCharacterLisetLen; i++) {
...
// *click function 角色技能
var functionClick = function functionClick() {
  // *狼人
...
var deadOne = function deadOne(idx) {
  // dead 掉已死對象
